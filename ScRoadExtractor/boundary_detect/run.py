...
if __name__ == '__main__':
  parser = argparse.ArgumentParser(description='Rough Edge Detection Algorithm')
  parser.add_argument('--img_root', default='/content/drive/MyDrive/Road-Network-Inference/ScRoadExtractor/data/train/sat/', type=str,
                        help='path to imagery')
  args = parser.parse_args()

  out_root = '/content/drive/MyDrive/Road-Network-Inference/ScRoadExtractor/data/train/rough_edge/'
  ...
  for name in name_list:
    region_info = name[:-7]
    arguments_strIn = args.img_root + region_info + 'sat.png'
